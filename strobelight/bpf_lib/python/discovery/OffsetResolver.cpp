...
OffsetResolver::OffsetResolver()
  ...
  symbolNameToInfo_ = {
      ...
      BPF_LIB_OPTIONAL_SYMBOL(PyThreadState_cframe),
      BPF_LIB_OPTIONAL_SYMBOL(PyThreadState_current_frame),
...
const OffsetConfig& OffsetResolver::getHeaderOffsetsForVersion(
  ...
  static const std::unordered_map<std::string_view, OffsetConfig>
      pythonOffsets = {
          ...
          {std::string_view("cpython-314"), kPy314OffsetConfig},
          {std::string_view("cpython-314t"), kPy314tOffsetConfig},
